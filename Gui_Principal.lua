...
local function criarGUI()
    ...
    local alturaOpcao = 0.12 -- Altura fixa para cada opção (aumentada)
    ...
    local margemInterna = 0.05 -- Margem interna entre os botões e as paredes da GUI lateral (aumentada)
